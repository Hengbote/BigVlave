...
void system_clock_config(int target_freq_mhz)
{
    ...
    */
    ...
    PeriphClkInit.PeriphClockSelection = RCC_PERIPHCLK_RTC;     //指定要配置的外设时钟，这里是 RTC 外设时钟
    PeriphClkInit.RTCClockSelection = RCC_RTCCLKSOURCE_LSE;     //指定 RTC 时钟源，这里选择低速外部时钟（LSE）作为 RTC 时钟源
